            ...
            <div className='CartItem'>
                <div className="item-details">
                    ...
                    <div className='details'>
                        ...
                        {item.itemId.startsWith("CK") &&
                        <div className="cake-message-section">
                            <label htmlFor={`message-${item.itemId}`}>Cake Message <span>(optional)</span>:</label>
                            <input
                              type="text"
    ...
    return(
        <>
            ...
            <div className='instruction'>
                ...
                Click on download PDF button to download your order summary and send this to us on <a href="https://wa.me/7992419378/">Whatsapp: +91 7991185428 </a>
            </div>
